 ...
 */
final class Version20230214231501 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE avis (id INT AUTO_INCREMENT NOT NULL, mail_partage VARCHAR(255) NOT NULL, suivi_formation VARCHAR(255) NOT NULL, formation_cachan VARCHAR(255) NOT NULL, mail_difuse VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
